...
from {{ cookiecutter.package_name }}.core.core_storage.base import FileMetadata, normalize_storage_path
from {{ cookiecutter.package_name }}.core.core_storage.exceptions import StorageError
