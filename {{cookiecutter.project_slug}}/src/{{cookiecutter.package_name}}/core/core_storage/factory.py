...
from {{ cookiecutter.package_name }}.core.core_storage.exceptions import StorageConfigError
from {{ cookiecutter.package_name }}.core.core_storage.settings import StorageBackend, get_storage_settings
...
def get_storage_client() -> StorageClient:
    ...
    if settings.STORAGE_BACKEND == StorageBackend.FILESYSTEM:
        from {{ cookiecutter.package_name }}.core.core_storage.filesystem import FilesystemStorageClient
