...
def require_acl_perm(
    ...
    *,
    ...
    Composes with :func:`~{{ cookiecutter.package_name }}.core.core_auth.deps.require_roles` — use both
    ...
    Returns:
        ...
        :class:`~{{ cookiecutter.package_name }}.core.core_auth.models.UserClaims` on success, or raises
