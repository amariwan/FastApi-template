...
class TestRegisterProfilingMiddleware:
    def test_disabled_passes_request_through_unchanged(self):
        from {{ cookiecutter.package_name }}.core.core_middleware.profiler_middleware import register_profiling_middleware
    ...
    def test_enabled_with_profile_param_html_format(self, tmp_path, monkeypatch):
        ...
        import {{ cookiecutter.package_name }}.core.core_middleware.profiler_middleware as mod
