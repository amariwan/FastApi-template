...
class TestHttpLoggingMiddleware:
    def test_disabled_does_not_register(self):
        from {{ cookiecutter.package_name }}.core.core_middleware.http_security_middleware import register_http_logging_middleware
...
class TestApiKeyMiddleware:
    def test_disabled_lets_request_through(self):
        from {{ cookiecutter.package_name }}.core.core_middleware.http_security_middleware import register_api_key_middleware
...
class TestRequestSizeMiddleware:
    def test_request_within_limit_passes(self):
        from {{ cookiecutter.package_name }}.core.core_middleware.http_security_middleware import register_request_size_middleware
...
class TestSecurityHeadersMiddleware:
    def test_disabled_does_not_add_headers(self):
        from {{ cookiecutter.package_name }}.core.core_middleware.http_security_middleware import (
...
class TestRateLimitMiddleware:
    def test_disabled_allows_unlimited_requests(self):
        from {{ cookiecutter.package_name }}.core.core_middleware.http_security_middleware import register_rate_limit_middleware
