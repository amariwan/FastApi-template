...
def test_ensure_db_schema_fetches_engine_from_manager(monkeypatch: MonkeyPatch) -> None:
    ...
    monkeypatch.setattr(
        "{{ cookiecutter.package_name }}.core.core_db.async_db_session_maker.get_db_settings",
    ...
    monkeypatch.setattr(
        "{{ cookiecutter.package_name }}.core.core_db.async_db_session_maker.get_sessionmanager",
